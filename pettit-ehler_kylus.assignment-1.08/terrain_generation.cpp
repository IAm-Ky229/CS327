...
void generatedMap::print_map(generatedMap *map_data) {
...
void generatedMap::place_border_boulders(generatedMap *map_data) {
...
void generatedMap::place_clearings(generatedMap *map_data) {
...
void generatedMap::place_tall_grass(generatedMap *map_data) {
...
void generatedMap::place_buildings(generatedMap *map_data, int building_spawn_rate) {
...
void generatedMap::place_pokemart(int selected_row, generatedMap *map_data) {
...
void generatedMap::place_pokecenter(int selected_column, generatedMap * map_data) {
...
void generatedMap::place_exits(generatedMap *map_data,
		 int exit_bottom,
		 int exit_right,
		 int exit_left,
		 int exit_top) {
...
void generatedMap::place_paths(generatedMap *map_data) {
...
void generatedMap::fill_blank_space(generatedMap *map_data) {
