...
void characterLogic::move_pacer(generatedMap *m, NPC_char *pacer_to_move, heap_t *h, PC_state &PC_s, int manhattan_x, int manhattan_y, std::vector<pokemon> pkmn_list, std::vector<pokemon_stats> pkmn_st, std::vector<pokemon_moves> pkmn_mv, std::vector<moves> mv, std::vector<pokemon_types> pkmn_typ) {
  ...
  if(m -> character_positions[pacer_to_move -> next_x][pacer_to_move -> next_y] != NULL) {
    if(m -> character_positions[pacer_to_move -> next_x][pacer_to_move -> next_y] -> player_type == PC &&
      ...
      characterLogic.engage_battle(PC_s, manhattan_x, manhattan_y, pkmn_list, pkmn_st, pkmn_mv, mv, pkmn_typ);
...
void characterLogic::move_via_shortest_path(generatedMap *m, movementCosts dijkstra[HORIZONTAL][VERTICAL], NPC_char *character_to_move, heap_t *h, PC_state &PC_s, int manhattan_x, int manhattan_y, std::vector<pokemon> pkmn_list, std::vector<pokemon_stats> pkmn_st, std::vector<pokemon_moves> pkmn_mv, std::vector<moves> mv, std::vector<pokemon_types> pkmn_typ) {
  ...
  if(m -> character_positions[character_to_move -> next_x][character_to_move -> next_y] != NULL) {
    if(m -> character_positions[character_to_move -> next_x][character_to_move -> next_y] -> player_type == PC &&
      ...
      engage_battle(PC_s, manhattan_x, manhattan_y, pkmn_list, pkmn_st, pkmn_mv, mv, pkmn_typ);
...
void characterLogic::move_wanderer(generatedMap *m, NPC_char *wanderer_to_move, heap_t *h, PC_state &PC_s, int manhattan_x, int manhattan_y, std::vector<pokemon> pkmn_list, std::vector<pokemon_stats> pkmn_st, std::vector<pokemon_moves> pkmn_mv, std::vector<moves> mv, std::vector<pokemon_types> pkmn_typ) {
...
void characterLogic::move_random_walker(generatedMap *m, NPC_char *walker_to_move, heap_t *h, PC_state &PC_s, int manhattan_x, int manhattan_y, std::vector<pokemon> pkmn_list, std::vector<pokemon_stats> pkmn_st, std::vector<pokemon_moves> pkmn_mv, std::vector<moves> mv, std::vector<pokemon_types> pkmn_typ) {
...
void characterLogic::move_PC(PC_char *player_char, generatedMap *m, std::vector<pokemon> pkmn_list, std::vector<pokemon_stats> pkmn_st, std::vector<pokemon_moves> pkmn_mv, std::vector<moves> mv, std::vector<pokemon_types> pkmn_typ, int manhattan_x, int manhattan_y, PC_state &PC_s) {
